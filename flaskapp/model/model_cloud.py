...
class Pet(db.Model):
    ...
    updated_date = db.Column(db.DateTime, nullable=False, default=db.func.current_timestamp())
    owner_id = db.Column(db.Integer, db.ForeignKey('owner.id'), nullable=False, index=True)
...
class Vaccination(db.Model):
    ...
    pet = db.relationship('Pet', primaryjoin=pet_id == Pet.id, backref='vaccinations')
...
class MedicalService(db.Model):
    ...
    pet = db.relationship('Pet', primaryjoin=pet_id == Pet.id, backref='medical_services')
